var unityFramework = (() => {
  ...
  return function (unityFramework) {
    ...
    function _GetWebGLWarpedTexture(targetId, textureId, resolution) {
      ...
      var textureCanvas = window.iTracker.GetWebGLWarpedTexture(
        UTF8ToString(targetId),
        canvasId,
        resolution
      );
    ...
    function _SetWebGLiTrackerSettings(settings) {
      window.iTracker.setTrackerSettings(
    ...
    function _StartWebGLiTracker(ids, name) {
      if (!window.iTracker) {
        console.error(
          "%ciTracker not found! Please make sure to use the iTracker WebGLTemplate in your ProjectSettings",
          "font-size: 32px; font-weight: bold"
        );
        throw new Error(
          "Tracker not found! Please make sure to use the iTracker WebGLTemplate in your ProjectSettings"
        );
        return;
      }
    ...
    function _WebGLIsCameraStarted() {
      if (!window.arCamera) {
        console.error(
          "%carCamera not found! Please make sure to use the correct WebGLTemplate in your ProjectSettings",
          "font-size: 32px; font-weight: bold"
        );
        throw new Error(
          "arCamera not found! Please make sure to use the correct WebGLTemplate in your ProjectSettings"
        );
        return;
      }
